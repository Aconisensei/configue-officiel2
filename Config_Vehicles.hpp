    ...
    */
    ...
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_F", "" }, //hayon
            { "C_Offroad_01_F", "" }, //tout terrain
            { "C_SUV_01_F", "" }, //suv
            { "C_Hatchback_01_sport_F", "" }, //hayon sport
            { "C_Van_02_vehicle_F", "" }, //van cargaison
            { "C_Van_02_transport_F", "" }, //van transport
            { "C_Offroad_02_unarmed_F", "" } //mb4 Dlc apex
        };
    };
    ...
    class civ_truck {
        ...
        conditions = "";
        vehicles[] = {
		    { "C_Van_01_fuel_F", "" }, //fourgon fuel
			{ "C_Van_01_box_F", "" }, //fourgon caisse
            { "I_Truck_02_transport_F", "" }, //zamak transport non convert
			{ "I_Truck_02_covered_F", "" }, //zamak transport couvert
			{ "I_Truck_02_fuel_F", "" }, //zamak fuel
            { "O_Truck_03_covered_F", "" }, //tempest couvert
            { "O_Truck_03_device_F", "" }, //tempest materiel
			{ "B_Truck_01_transport_F", "" }, //hemtt transport non convert
            { "B_Truck_01_covered_F", "" }, //hemtt transport couvert 
    ...
    class cop_air {
        ...
        vehicles[] = {
            { "B_Heli_Light_01_dynamicLoadout_F", "license_cop_cAir" },
            { "B_Heli_Attack_01_dynamicLoadout_F", "license_cop_cAir" },
			{ "B_Heli_Light_01_F", "license_cop_cAir" },
			{ "B_Heli_Transport_01_F", "license_cop_cAir" },
			{ "B_Plane_CAS_01_dynamicLoadout_F", "license_cop_cAir" }
        };
    };
